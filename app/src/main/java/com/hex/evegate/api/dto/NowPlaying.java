...
public class NowPlaying {
    @SerializedName("elapsed") private String elapsed;
    ...
    @SerializedName("remaining") private String remaining;
    ...
    {
        return "ClassPojo [elapsed = "+elapsed+", sh_id = "+sh_id+", duration = "+duration+", song = "+song+", is_request = "+is_request+", playlist = "+playlist+", played_at = "+played_at+", remaining = "+remaining+"]";
    }
}
